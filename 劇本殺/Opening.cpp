...
void Opening::SceneOP(Scene& scene) {
	cout << "\n一個陰雨連綿的晚上，你為了要躲雨來到一座位於偏僻山脈的神秘莊園" << endl;
	Sleep(2000);
...
void Opening::HandleHouseSubChoice(int choice) {
	...
	case 1:
		...
		switch (choice) {
		case 1:
			cout << "\n你打開寶箱，發現裡面有一個神秘的寶石。" << endl;
			treasureItem = "神秘的寶石";
			cout << "你獲得了一個 " << treasureItem << "。" << endl;
			Conclusion();
			return;
		case 2:
			cout << "\n你檢查房間，但沒有發現其他有價值的東西。" << endl;
			Conclusion();
			return;
		case 3:
			SceneHouse();
...
void Opening::HandleOutSubChoice(int choice) {
	...
	case 2:
		...
		case 1:
			...
			switch (choice) {
			case 1:
				cout << "\n你打開寶藏，發現了一個古老的手稿。" << endl;
				Conclusion();
				return;
			case 2:
				cout << "\n你繼續探索地下室，但沒有發現其他特別的東西。" << endl;
				Conclusion();
				return;
			case 3:
				SceneHouse();
...
void Opening::HandlePeopleSubChoice(int choice) {
	...
	case 1:
		...
		case 1:
			...
			break;
		case 2:
			cout << "\n你繼續與守衛交談，但他似乎不願多說。" << endl;
			Conclusion();
			return;
		case 3:
			cout << "\n守衛帶你前往地下室，發現了一個寶藏。" << endl;
			cout << "1. 打開寶藏" << endl;
			cout << "2. 繼續探索地下室" << endl;
			cout << "3. 返回地面" << endl;
			cin >> choice;
	...
	case 2:
		...
		switch (choice) {
		case 1:
			cout << "\n你打開箱子，發現了一個古老的手稿。" << endl;
			Conclusion();
			return;
		case 2:
			cout << "\n你檢查周圍，但沒有發現其他特別的東西。" << endl;
			Conclusion();
			return;
		case 3:
			SceneHouse();
	...
	case 3:
		...
		switch (choice) {
		case 1:
			cout << "\n你仔細研究畫作，發現了一些隱藏的符號。" << endl;
			Conclusion();
			return;
		case 2:
			cout << "\n你檢查其他物品，但沒有發現其他特別的東西。" << endl;
			Conclusion();
			return;
		case 3:
			cout << "\n你詢問守衛畫作的來歷，但他似乎不願多說。" << endl;
			Conclusion();
			return;
		default:
			cout << "錯誤的選項，請重新輸入" << endl;
